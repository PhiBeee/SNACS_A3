...
#Where 𝑅𝑡 𝑢1, 𝑢2 represents the number of retweets between
#two users. 𝑅𝑇 and 𝑈 are the total number of retweet and users
#respectively. 𝑀𝑡 𝑢1, 𝑢2 represents the number of mentions
